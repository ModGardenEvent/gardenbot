...
public class SubmissionModrinthCreateCommand extends SlashCommand {
	public SubmissionModrinthCreateCommand() {
		super(
				"modrinth",
	...
	public Response respond(SlashCommandInteraction interaction) {
		return new MessageResponse("Submissions not currently implemented.");
