...
//
//		try {
//			HttpResponse<InputStream> stream = ModGarden.post(
...
//				var eventResult = ModGarden.get("events/current/development", HttpResponse.BodyHandlers.ofInputStream());
...
//						var submissionsStream = ModGarden.get("user/" + modGardenUser.id + "/submissions/" + currentEvent.slug, HttpResponse.BodyHandlers.ofInputStream());
...
//												String title = slug;
//
//												var modrinthStream = Modrinth.get("v2/project/" + modGardenProject.modrinthId, HttpResponse.BodyHandlers.ofInputStream());
...
//			String project = optionCompletionGetter.getOption("project", OptionMapping::getAsString);
//
...
//
//			try {
//				var eventStream = ModGarden.get("events/current/development", HttpResponse.BodyHandlers.ofInputStream());
//				var modrinthStream = Modrinth.get("v2/project/" + project, HttpResponse.BodyHandlers.ofInputStream());
...
//							try {
//								var versionStream = Modrinth.get("v2/version/" + versionId, HttpResponse.BodyHandlers.ofInputStream());
